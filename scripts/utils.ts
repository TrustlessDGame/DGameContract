...
export async function deployOrUpgradeZk (wallet: Wallet, address: any, contractName: any, constructorParams: any[], isInitializable: boolean){
...
async function deployOrUpgradeLocal(address: any, contractName: any, constructorParams: any[], isInitializable : boolean){
...
export const deployContractUpgradable = async (contractArtifactName: string, wallet: Wallet, constructorArguments?: any[]) => {
...
export const getContract = async(adminWallet: any, contractName: any, address: any) => {
